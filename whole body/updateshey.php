<?php
  ...
  $sel="SELECT * from sheyphoksundo WHERE id ='$id'";
  $run=mysqli_query($connect,$sel);
  $row=mysqli_fetch_assoc($run);
  ?>
  <form action ="updateshey.php" method="post">
    ...
    if(isset($_POST['submit'])){
    	...
    	$r=$_POST['c'];
      $s=$_POST['d'];
    	$update="UPDATE sheyphoksundo SET fullname ='$or', address='$q', email='$r', number='$s' WHERE id='$id'";
