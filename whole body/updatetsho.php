<?php
  ...
  $sel="SELECT * from tshorolpa WHERE id ='$id'";
  $run=mysqli_query($connect,$sel);
  $row=mysqli_fetch_assoc($run);
  ?>
  <form action ="updatetsho.php" method="post">
    ...
    if(isset($_POST['submit'])){
    	...
    	$r=$_POST['c'];
      $s=$_POST['d'];
    	$update="UPDATE tshorolpa SET fullname ='$or', address='$q', email='$r', number='$s' WHERE id='$id'";
